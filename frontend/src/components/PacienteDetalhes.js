      ...
      {paciente && (
        <>
          <div className="ficha">
            ...
            <span id="paciente">
              <figure>
                <img src="../pacient.png" alt="paciente" />
              </figure>
              <p>
            ...
            <div className="infos-paciente">
              <p>
                <strong>Telefone:</strong> {paciente.fone}
              </p>
              <p>
                <strong>Endereço:</strong> {paciente.endereco}
              </p>
              <p>
                <strong>Medicamentos:</strong> {paciente.remedio}
              </p>
              <p>
                <strong>Comorbidades/Condições Pré-Existentes:</strong>{" "}
                {paciente.comorbidade}
              </p>
              <em className="espaco"></em>
              {!isAssistente ? (
                <p>
                  <strong>Histórico do Paciente/Prontuário:</strong>
                  <br />
        ...
        <div className="modal">
          <div className="modal-content">
            ...
            <h4 className="msg-deletar">
              Tem certeza que deseja deletar os dados do paciente?
            </h4>
